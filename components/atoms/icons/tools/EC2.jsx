const EC2 = ({ size = '32' }) => {
  // The original SVG is 80x80, so we keep the viewBox and scale with the size prop
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <defs>
        <linearGradient x1="0%" y1="100%" x2="100%" y2="0%" id="ec2-linearGradient-1">
          <stop stopColor="#C8511B" offset="0%"></stop>
          <stop stopColor="#FF9900" offset="100%"></stop>
        </linearGradient>
      </defs>
      <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g fill="url(#ec2-linearGradient-1)">
